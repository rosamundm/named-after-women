      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <main className="space-y-8">
          ...
          <ul>
            ...
            <li>
                Frontend built with <a href="https://react.dev/"><u>React</u></a> and <a href="https://tailwindcss.com/"><u>Tailwind</u></a>, deployed on <a href="https://www.netlify.com/">Netlify</a>.
            </li>
          </ul>
          <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            And for a while, this kind of worked. I spoke about the project at <a href="https://www.youtube.com/watch?v=quuJomdu568"><u>conferences</u></a> and meetups.
            I was super proud of it and saw lots of potential in it. However, I knew it was going to take forever to complete. After all, there was lots of technical maintenance
            to be done, not to mention adding all the content. On top of a full-time job, other personal projects, life generally, and, you know, finding time to rest, I started to
