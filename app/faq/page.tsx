      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <Accordion.Root type="single" collapsible className="w-full">
          ...
          <Accordion.Item value="item-1">
            <Accordion.Trigger className="group flex w-full items-center justify-between p-3">
              ...
              <span className="transition-transform">
                ...
                {/* rotate plus symbol on click: */}
                <X className="h-5 w-5 hidden group-data-[state=open]:block" />
              </span>
            </Accordion.Trigger>
            <Accordion.Content>
              <p className="p-3 text-lg text-muted-foreground leading-relaxed">
          ...
          <Accordion.Item value="item-5">
            <Accordion.Trigger className="group flex w-full items-center justify-between p-3">
              <span className="text-l font-bold">
                What ever happened to the detailed description of the life of the
            ...
            <Accordion.Content>
              <p className="p-3 text-lg text-muted-foreground leading-relaxed">
               Reasons for the disappearance of that are detailed <a href="/colophon"><u>here</u></a>. Whenever I get capacity to
               think about how to make this site sustainably non-static again, they may well return...
              </p>
            </Accordion.Content>
          </Accordion.Item>
