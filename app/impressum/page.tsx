      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <main className="space-y-8">
          ...
          <ul className="text-lg text-muted-foreground leading-relaxed">
            {getImpressumAddress() &&
              getImpressumAddress()?.map((line: string, i: number) => (
                <li key={i}>{line}</li>
              ))}
          </ul>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Die durch den Seitenbetreiber erstellten bzw. verwendeten Inhalte
            ...
            Gebrauch gestattet. Soweit die Inhalte auf dieser Seite nicht von
            dem Betreiber erstellt wurden, werden die Urheberrechte Dritter
