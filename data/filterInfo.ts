...
export const getTagInfo = (streets: Street[]) => (
    [
        ...
        },
        {
            ...
            descriptiveName: 'sciences & engineering',
            count: getTagCount('sciences & engineering', streets),
        },
        {
            name: 'education',
        ...
        {
            name: 'sports',
            descriptiveName: 'sports',
            count: getTagCount('sports', streets),
        },
        {
            name: 'international',
        ...
        {
            name: 'aristocracy',
            descriptiveName: 'aristocracy',
            count: getTagCount('aristocracy', streets),
        },
        {
            name: 'other',
